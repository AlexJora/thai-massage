  ...
  return (
    <section className="relative bg-center bg-no-repeat bg-cover h-80">
      <div className="absolute inset-0 z-0">
        <picture>
          {/* Mobile Image */}
          <source media="(max-width: 768px)" srcSet="/assets/button/button3-sm.webp" />

          {/* Desktop Image */}
          <source media="(min-width: 769px)" srcSet="/assets/button/button3-lg.webp" />

          {/* Fallback Image */}
          <Image
            src="/assets/button3-lg.webp"
            alt="spa decoration"
